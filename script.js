...
function renderKeyboard (toggleLang, shift) {
  ...
  textField.placeholder = 'Windows 10. Opera GX. \nНажмите Shift, чтобы сменить раскладку. \nРаскладка может меняться не с первого раза. Это не баг, а фича. Перезагрузите страницу.'
